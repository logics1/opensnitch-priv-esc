...
2. Config takeover -- Whoever is on the other end of the socket from step 1 can send a CHANGE_CONFIG notification over the bidirectional Notifications stream, and the daemon parses, applies, and persists it to /etc/opensnitchd/default-config.json.
